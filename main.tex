...
\>[3]{}\mbox{\enskip\{-\# LANGUAGE KindSignatures, GADTs, RankNTypes, LambdaCase  \#-\}\enskip}{}\<[E]%
\ColumnHook
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathbf{import}\;\Conid{Prelude}\;\Varid{hiding}\;(\Varid{or}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathbf{type}\;\Conid{Parser1}\;\Varid{a}\mathrel{=}\Conid{Int}{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\Varid{pure}\mathbin{::}\Varid{a}\to \Conid{Parser1}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\Varid{pure}\mathrel{=}\bot {}\<[E]%
\\
\>[3]{}\Varid{satisfy}\mathbin{::}(\Conid{Char}\to \Conid{Bool})\to \Conid{Parser1}\;\Conid{Char}{}\<[E]%
\\
\>[3]{}\Varid{satisfy}\mathrel{=}\bot {}\<[E]%
\\
\>[3]{}\Varid{empty}\mathbin{::}\Conid{Parser1}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\Varid{empty}\mathrel{=}\bot {}\<[E]%
\\
\>[3]{}\Varid{try}\mathbin{::}\Conid{Parser1}\;\Varid{a}\to \Conid{Parser1}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\Varid{try}\mathrel{=}\bot {}\<[E]%
\\
\>[3]{}\Varid{ap}\mathbin{::}\Conid{Parser1}\;(\Varid{a}\to \Varid{b})\to \Conid{Parser1}\;\Varid{a}\to \Conid{Parser1}\;\Varid{b}{}\<[E]%
\\
\>[3]{}\Varid{ap}\mathrel{=}\bot {}\<[E]%
\\
\>[3]{}\Varid{or}\mathbin{::}\Conid{Parser1}\;\Varid{a}\to \Conid{Parser1}\;\Varid{a}\to \Conid{Parser1}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\Varid{or}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{a}\mathbin{::}\Conid{Parser1}\;\Conid{Char}{}\<[E]%
\\
\>[3]{}\Varid{a}\mathrel{=}\Varid{satisfy}\;(\equiv \text{\ttfamily 'a'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{b}\mathbin{::}\Conid{Parser1}\;\Conid{Char}{}\<[E]%
\\
\>[3]{}\Varid{b}\mathrel{=}\Varid{satisfy}\;(\equiv \text{\ttfamily 'b'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{aorb}\mathbin{::}\Conid{Parser1}\;\Conid{Char}{}\<[E]%
\\
\>[3]{}\Varid{aorb}\mathrel{=}\Varid{a}\mathbin{`\Varid{or}`}\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathbf{data}\;\Conid{Parser2}\mathbin{::}\mathbin{*}\to \mathbin{*}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Pure2}\mathbin{::}\Varid{a}\to \Conid{Parser2}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Satisfy2}\mathbin{::}(\Conid{Char}\to \Conid{Bool})\to \Conid{Parser2}\;\Conid{Char}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Empty2}\mathbin{::}\Conid{Parser2}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Try2}\mathbin{::}\Conid{Parser2}\;\Varid{a}\to \Conid{Parser2}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Ap2}\mathbin{::}\Conid{Parser2}\;(\Varid{a}\to \Varid{b})\to \Conid{Parser2}\;\Varid{a}\to \Conid{Parser2}\;\Varid{b}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Or2}\mathbin{::}\Conid{Parser2}\;\Varid{a}\to \Conid{Parser2}\;\Varid{a}\to \Conid{Parser2}\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[3]{}\Varid{size}\;(\Conid{Pure2}\;\anonymous )\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[3]{}\Varid{size}\;(\Conid{Satisfy2}\;\anonymous )\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[3]{}\Varid{size}\;\Conid{Empty2}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[3]{}\Varid{size}\;(\Conid{Try2}\;\Varid{px})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{size}\;\Varid{px}{}\<[E]%
\\
\>[3]{}\Varid{size}\;(\Conid{Ap2}\;\Varid{pf}\;\Varid{px})\mathrel{=}\Varid{size}\;\Varid{pf}\mathbin{+}\Varid{size}\;\Varid{px}\mathbin{+}\mathrm{1}{}\<[E]%
\\
\>[3]{}\Varid{size}\;(\Conid{Or2}\;\Varid{px}\;\Varid{py})\mathrel{=}\Varid{size}\;\Varid{px}\mathbin{+}\Varid{size}\;\Varid{py}\mathbin{+}\mathrm{1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

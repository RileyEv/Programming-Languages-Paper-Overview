...
\\
\>[3]{}\Varid{yAlg}\codeskip \Conid{EmptyF}{}\<[21]%
\>[21]{}\mathrel{=}\Conid{Y}\mathbin{\$}\Varid{const}\codeskip [\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
...
\>[13]{}(\Conid{IFunctor}\codeskip \Varid{f},\Conid{IFunctor}\codeskip \Varid{g}){}\<[E]%
\\
\>[13]{}\Rightarrow \Conid{IFunctor}\codeskip (\Varid{f}:\!\!+\!\!:\Varid{g})\codeskip \mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{imap}\codeskip {}\<[11]%
\>[11]{}\Varid{f}\codeskip (\Conid{L}\codeskip \Varid{x})\mathrel{=}\Conid{L}\codeskip (\Varid{imap}\codeskip \Varid{f}\codeskip \Varid{x}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{imap}\codeskip {}\<[11]%
\>[11]{}\Varid{f}\codeskip (\Conid{R}\codeskip \Varid{y})\mathrel{=}\Conid{R}\codeskip (\Varid{imap}\codeskip \Varid{f}\codeskip \Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Now the datatypes can be defined for each constructor that is required. The \ensuremath{\Conid{IFunctor}} instances for each constructor can be found in the appendix.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
...
\ColumnHook
\end{hscode}\resethooks
There is however, one problem with this approach: there is now a mess of \ensuremath{\Conid{L}} and \ensuremath{\Conid{R}}'s. This makes this approach inconvenient to use.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{14}{@{}>{\hspre}l<{\hspost}@{}}%
...
Data types à la carte~\cite{datatypesalacarte}, however, describes a technique that allows for the injection of these \ensuremath{\Conid{L}}'s and \ensuremath{\Conid{R}}'s.
...
\>[13]{}(\Conid{IFunctor}\codeskip \Varid{f},\Conid{IFunctor}\codeskip \Varid{g}){}\<[E]%
\\
\>[13]{}\Rightarrow \Varid{f}:\prec:(\Varid{f}:\!\!+\!\!:\Varid{g})\codeskip \mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{inj}{}\<[10]%
...
\>[13]{}(\Conid{IFunctor}\codeskip \Varid{f},\Conid{IFunctor}\codeskip \Varid{g},{}\<[E]%
\\
\>[13]{}\Conid{IFunctor}\codeskip \Varid{h},\Varid{f}:\prec:\Varid{g}){}\<[E]%
\\
\>[13]{}\Rightarrow \Varid{f}:\prec:(\Varid{h}:\!\!+\!\!:\Varid{g})\codeskip \mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\\[\blanklineskip]%
\>[3]{}\Varid{satisfy}_{10}\mathbin{::}(\Conid{Satisfy}_{10}:\prec:\Varid{f}){}\<[35]%
\>[35]{}\Rightarrow (\Conid{Char}\to \Conid{Bool}){}\<[E]%
\\
\>[35]{}\to \Conid{Fix}\codeskip \Varid{f}\codeskip \Conid{Char}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[3]{}\mathbf{instance}\codeskip {}\<[13]%
\>[13]{}(\Conid{SizeAlg}\codeskip \Varid{f},\Conid{SizeAlg}\codeskip \Varid{g}){}\<[E]%
\\
\>[13]{}\Rightarrow \Conid{SizeAlg}\codeskip (\Varid{f}:\!\!+\!\!:\Varid{g})\codeskip \mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\\
\>[3]{}\Varid{eval}\mathrel{=}\Varid{coerce}\codeskip {}\<[18]%
...
There could possibly an error in the paper here as it uses \ensuremath{\Conid{Circuit}_{11}}.
This requires that the \ensuremath{\Conid{WidthAlg}_{11}} instances be defined for all constructors in \ensuremath{\Conid{Circuit}_{11}}, however, only \ensuremath{\Conid{Fan}_{11}} and \ensuremath{\Conid{Stretch}_{11}} have been.
